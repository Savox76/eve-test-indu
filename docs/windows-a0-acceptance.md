...
| ---: | --- | --- |
| 1 | Installation `v0.0.5-preview.23` | Der Current-User-Installer beendet sich erfolgreich und die Anwendung startet ohne Entwicklerwerkzeuge. Es erscheint nur die grafische Übersicht und kein zusätzliches Konsolenfenster. |
...
| 5 | Installer-Update | Nach vollständigem Schließen wird `v0.0.5-preview.23` über `.16`, `.17`, `.19`, `.20`, `.21` oder `.22` installiert. Die Datenlöschung bleibt abgewählt; anschließend sind Version, Charaktere, Einstellungen, Pläne und Snapshots vorhanden und `data` liegt neben der EXE. |
