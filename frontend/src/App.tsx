Warning: truncated output (original token count: 60394)
Total output lines: 4925
      ...
      <main className="main-content">
        ...
        <section className={`sso-panel sso-panel--${ssoStatus.state}`} aria-labelledby="sso-title">
          ...
          <div className="sso-panel__copy" aria-live="polite">
            ...
            <strong id="sso-title">{t.sso.states[ssoStatus.state].title}</s…10394 tokens truncated…abel}>
