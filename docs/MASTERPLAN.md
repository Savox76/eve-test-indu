...
| 40 | Einkaufsliste und EVE-Multibuy | Konfliktfreie Fehlmengen werden typweise zusammengeführt, unvollständige Quellstände sichtbar ausgeschlossen und als direkt kopierbare EVE-Multibuy-Liste ausgegeben; Paket 48 begrenzt die Ausgabe auf das ausdrücklich ausgewählte Ziel |
...
| 45 | Verkaufswert und belegbare Rohmarge | Das ausgewählte Ziel bewertet sämtliche verbrauchten Materialien einschließlich vorhandenen Bestands zum vollständigen Wiederbeschaffungswert, addiert Installationskosten und vergleicht die Summe mit dem Bruttoverkaufswert zum niedrigsten stationsexakten Sell-Angebot; Handelsgebühren bleiben getrennt |
...
- **Abgeschlossen:** 40 – Die Produktionsabfrage führte eine stabil nach Typ-ID zusammengeführte EVE-Multibuy-Liste ein. Physische Fehlmenge und durch vorrangige Ziele gebundene Menge bleiben getrennt. Paket 48 ersetzt die frühere Zusammenfassung aller gefilterten Ziele durch die ausdrücklich ausgewählte Zielvariante, ohne die globale konfliktfreie Reservierung zu verändern. Das Schema bleibt bei Version 13.
...
- **Abgeschlossen:** 45 – Die vollständigen äußeren Materialmengen werden unabhängig vom vorhandenen Bestand nach realer Sell-Order-Tiefe als Wiederbeschaffungskosten bewertet. Der stationsexakte niedrigste Sell-Preis des Zielprodukts liefert einen ausdrücklich nicht garantierten Bruttoverkaufswert. Zusammen mit den vollständigen Installationskosten entstehen Produktionskosten, Rohgewinn oder -verlust und Rohmarge vor Brokergebühren und Verkaufssteuer. Paket 48 bindet diese Bewertung an das ausgewählte Ziel und nutzt dieselbe Rechnung für den Hubvergleich. Das Schema bleibt bei Version 14.
