...
- **In Arbeit:** 22 – Der Gerätetest bestätigte Installer, Betrieb ohne Administratorrechte, Einzelinstanz, sauberes Prozessende, Update und updatefesten Speicher. `v0.0.5-preview.14` ist der Korrekturkandidat für die gemeldeten ESI-, SDE-, Filter-, Schrift- und Cachebefunde. Das vollständige A0-Protokoll bleibt vor der ersten `0.2.0`-Alpha erforderlich.
