...
**Technische Preview – `v0.0.5-preview.13`.** Assets, Blueprints, persönliche Industrieaufträge und die vollständigen Skillstände aller aktivierten Charaktere werden beim Programmstart charaktergetrennt synchronisiert. Anlagen, Systemkosten, Forschungsplanung und Industrie-Slots verbinden diese vollständigen Quellen ohne unbekannte Werte als null zu schätzen. Paket 30 ergänzt persistente Fertigungs- und Reaktionsziele: Die App löst die gewählten SDE-Rezepte deterministisch in Produktionsschritte, ganzzahlig gerundete Läufe, Überschuss, Basiszeit und äußeren Bruttomaterialbedarf auf. Bestand, Reservierungen, Blueprint-ME, Charakter-, Anlagen- und Rigmodifikatoren, Steuern und Preise bleiben dabei ausdrücklich unberücksichtigt. Alle echten Ansichten sind zweisprachig, durchsuchbar, filterbar und begrenzt.

Charakteridentitäten, Aliasse, Gruppen, Scope-Status, Forschungs- und Produktionspläne stammen aus SQLite; Refresh Tokens bleiben im Windows-Anmeldespeicher und Access Tokens ausschließlich im Sidecar-Prozess. Die App prüft automatisch und auf Knopfdruck, ob im gewählten Kanal ein vollständiges neueres GitHub Release bereitsteht, und zeigt den passenden Installer- oder Portable-Hinweis. Download und Installation bleiben bis zu einer produktiv signierten Updatekette bewusst manuell. `v0.0.5-preview.13` ist der aktuelle Kandidat für die [verbindliche Windows-A0-Abnahme](docs/windows-a0-acceptance.md).
