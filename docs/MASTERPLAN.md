...
- **In Arbeit:** 22 – Der Gerätetest bestätigte Installer, Betrieb ohne Administratorrechte, Einzelinstanz, sauberes Prozessende und Release-Erkennung. `v0.0.5-preview.15` vereinheitlicht den sichtbaren `data`-Ordner direkt neben Installer- und Portable-EXE und übernimmt den bisherigen `.13/.14`-AppData-Bestand atomar. Das vollständige A0-Protokoll bleibt vor der ersten `0.2.0`-Alpha erforderlich.
