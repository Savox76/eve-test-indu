...
| ---: | --- | --- |
| 1 | Installation `v0.0.5-preview.25` | Der Current-User-Installer beendet sich erfolgreich und die Anwendung startet ohne Entwicklerwerkzeuge. Es erscheint nur die grafische Übersicht und kein zusätzliches Konsolenfenster. |
...
| 5 | Installer-Update | Nach vollständigem Schließen wird `v0.0.5-preview.25` über `.16`, `.17`, `.19`, `.20`, `.21`, `.22`, `.23` oder `.24` installiert. Die Datenlöschung bleibt abgewählt; anschließend sind Version, Charaktere, Einstellungen, Pläne und Snapshots vorhanden und `data` liegt neben der EXE. |
