...
Die Forschungsplanung befindet sich unter **Blueprints & Jobs**. Suche, Besitzer-, Status- und Gespeichert-Filter sowie Sortierung und Seitenteilung laufen im lokalen Sidecar; pro Anfrage werden höchstens 200 und in der Oberfläche standardmäßig 100 Zeilen übertragen. Nach einem Blueprint-, Skill-, Job- oder Anlagenabgleich wird die Ansicht neu geladen, damit Zustand, Slots und Belege denselben aktuellen lokalen Datenstand verwenden.
