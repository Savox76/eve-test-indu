...
Sicherheitsrelevante Beobachtungen bitte nicht in einem öffentlichen Issue veröffentlichen. Für dieses private Repository ist bevorzugt ein privater Security Advisory unter **Security → Advisories** zu verwenden. Falls dieser Weg nicht verfügbar ist, den Repository-Eigentümer direkt über GitHub kontaktieren und zunächst keine vertraulichen Details öffentlich teilen.
