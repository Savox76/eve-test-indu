  ...
  de: {
    ...
    blueprints: {
      ...
      profitability: {
        ...
        subtitle: "Vergleicht alle Blueprints deines Bestands an fünf Handelsstationen – ohne Produktionsziele anzulegen.",
        ...
        exactHint: "Vergleich für die eingestellten Läufe; Kopien werden auf verfügbare Läufe begrenzt. Alle direkten Materialien werden an der jeweiligen Handelsstation gekauft. Vorhandene Materialien zählen zum Wiederbeschaffungswert. Blueprint-Kauf, Transport und erneute Einstellgebühren sind nicht enthalten.",
        goal: "Blueprint im Bestand / Produkt",
        best: "Beste Station",
        noPrice: "Nicht berechenbar",
        margin: "{margin} % Marge",
    ...
    productionPlanning: {
      ...
      facilityChoice: "Produktionsstation / Struktur",
      noFacilityChoice: "Alle persönlichen Lagerorte",
      materialSource: "Materiallager",
      allFacilityLocations: "Gesamter Bestand dieser Station",
      containerOption: "{name} · Container #{id}",
      ...
      facilityStepTime: "Zeit mit Anlage {time} · Anlage spart {saved}",
      facilityModifierStateLabels: {
        "not-selected": "Keine Anlage gewählt",
        unconfigured: "Anlagenprofil nicht konfiguriert",
        ready: "Anlagenprofil aktiv",
        "activity-mismatch": "Anlagenprofil gilt nicht für diese Aktivität",
      },
      locationStateLabels: {
        unselected: "Produktionsort offen", ready: "Produktionsort gewählt",
        "facility-missing": "Produktionsstation fehlt",
        "material-location-missing": "Materiallager fehlt",
      },
      blueprintAssignment: "Persönlicher Blueprint",
      stepBlueprintAssignment: "Blueprint für diesen Schritt",
      noBlueprint: "Nicht zugewiesen",
      blueprintOption: "{kind} #{item} · ME {me} · TE {te} · {runs} Läufe",
      blueprintRunsInsufficient: "zu wenige Läufe",
      blueprintStateLabels: {
        ready: "Blueprint bereit", unassigned: "Blueprint nicht zugewiesen",
        "snapshot-missing": "Blueprint-Snapshot fehlt", missing: "Blueprint fehlt",
        "type-mismatch": "Falscher Blueprint-Typ", "runs-insufficient": "BPC-Läufe reichen nicht",
      },
      blueprintEvidence: "{kind} #{item} · ME {me} · TE {te} · {runs} Läufe",
      blueprintSource: "Blueprint-Snapshot #{snapshot} · Lauf #{run} · {date}",
      blueprintSnapshotMissing: "Kein vollständiger persönlicher Blueprint-Snapshot vorhanden.",
      materialEfficiencyApplied: "ME {me} wird auf den zugeordneten Ziel-Fertigungsschritt angewendet.",
      timeEfficiencyApplied: "TE {te} verkürzt die Blueprint-Zeit des zugeordneten Ziel-Fertigungsschritts.",
      skillStateLabels: { ready: "Skill-Zeit verfügbar", "snapshot-missing": "Skill-Snapshot fehlt" },
      skillEvidence: "Persönliche Skill-Zeitbasis",
      skillSource: "Skill-Snapshot #{snapshot} · Lauf #{run} · {date}",
      skillSnapshotMissing: "Kein vollständiger Skill-Snapshot vorhanden. Die persönliche Zeit bleibt unbekannt.",
      skillSummary: "Zeit nach Skills {time} · {saved} gegenüber Blueprint-Zeit gespart",
      ...
      installationCostTitle: "Vollständige belegte Installationskosten",
      installationCostSummary: "Geschätzt {total} ISK · EIV {eiv} · System {system} · Anlagensteuer {tax} · SCC (4 %) {scc}",
      installationCostStateLabels: {
        ready: "Kostenbasis bereit", partial: "Teilweise berechenbar",
        unconfigured: "Anlagensteuer nicht konfiguriert", unavailable: "Kostenbasis nicht verfügbar",
        "not-applicable": "Nicht anwendbar", "not-selected": "Keine Anlage gewählt",
        "facility-snapshot-missing": "Anlagen-Snapshot fehlt", "facility-missing": "Anlage fehlt",
        "facility-unavailable": "Anlage nicht verfügbar", "cost-index-missing": "Systemkostenindex fehlt",
        "price-snapshot-missing": "Preissnapshot fehlt", "price-missing": "Angepasster Preis fehlt",
      },
      installationCostSource: "Preissnapshot #{snapshot} · Lauf #{run} · {date}",
      installationCostMissingPrices: "Fehlende Typ-IDs: {types}",
      materialSaved: "{quantity} durch ME und Anlagenprofil gespart",
      target: "Zielmenge",
      priority: "Priorität",
      note: "Notiz",
      notePlaceholder: "Optionaler Planungshinweis",
      ...
      supplies: "Bezugsart der Vorprodukte",
      supplyHint: "Bestand zuerst kürzt den Fertigungsschritt; nur Bestand/Zukauf benötigt keinen Blueprint.",
      supplyModeLabels: {
        "stock-first": "Bestand zuerst", "stock-only": "Nur Bestand / Zukauf",
        build: "Selbst herstellen",
      },
      supplySummary: "Bedarf {required} · Bestand {stock} · Herstellung {build} · Fehlmenge {missing}",
      noBlueprintNeeded: "Kein Blueprint für diesen Vorproduktschritt erforderlich",
      ...
      blueprintTime: "Blueprint-Zeit {time} · TE {te} spart {saved}",
      gross: "Bruttomaterialbedarf",
      inventory: "Bestandsreservierung",
      inventoryLabels: {
        covered: "Reservierung gedeckt", shortage: "Fehlmenge", "snapshot-missing": "Asset-Snapshot fehlt",
        "not-applicable": "Nicht anwendbar",
      },
      required: "Bedarf",
      available: "Bestand",
      reserved: "Dieses Ziel",
      remaining: "Danach frei",
      missing: "Fehlt",
      ...
      reservationShortage: "{inventory} physisch fehlend · {conflict} durch vorrangige Ziele gebunden",
      priorReservations: "Vorrangige Ziele · {quantity} reserviert · Zielanzahl {plans}",
      reservationClaim: "Ziel #{plan} · {product}",
      reservationClaimDetails: "Priorität {priority} · {quantity} reserviert",
      reservationsOmitted: "Weitere {count} vorrangige Reservierungen sind berücksichtigt.",
      includedStock: "Bestandssnapshot · {quantity} in {locations} Orten",
  ...
  en: {
    ...
    blueprints: {
      ...
      profitability: {
        ...
        subtitle: "Compares all owned blueprints at five trade hubs without creating production goals.",
        ...
        exactHint: "Uses the configured runs, capped to remaining copy runs. All direct inputs are purchased at each hub; existing stock is valued at replacement cost. Blueprint acquisition, transport and relisting fees are excluded.",
        goal: "Owned blueprint / product",
        best: "Best hub",
        noPrice: "Not calculable",
    ...
    productionPlanning: {
      ...
      facilityChoice: "Production station / structure",
      noFacilityChoice: "All personal inventory locations",
      materialSource: "Material storage",
      allFacilityLocations: "All inventory at this facility",
      containerOption: "{name} · container #{id}",
      ...
      facilityStepTime: "Time at facility {time} · facility saves {saved}",
      facilityModifierStateLabels: {
        "not-selected": "No facility selected",
        unconfigured: "Facility profile not configured",
        ready: "Facility profile active",
        "activity-mismatch": "Facility profile does not apply to this activity",
      },
      locationStateLabels: {
        unselected: "Production location open", ready: "Production location selected",
        "facility-missing": "Production facility missing",
        "material-location-missing": "Material storage missing",
      },
      blueprintAssignment: "Personal blueprint",
      stepBlueprintAssignment: "Blueprint for this step",
      noBlueprint: "Unassigned",
      blueprintOption: "{kind} #{item} · ME {me} · TE {te} · {runs} runs",
      blueprintRunsInsufficient: "insufficient runs",
      blueprintStateLabels: {
        ready: "Blueprint ready", unassigned: "Blueprint unassigned",
        "snapshot-missing": "Blueprint snapshot missing", missing: "Blueprint missing",
        "type-mismatch": "Wrong blueprint type", "runs-insufficient": "Insufficient BPC runs",
      },
      blueprintEvidence: "{kind} #{item} · ME {me} · TE {te} · {runs} runs",
      blueprintSource: "Blueprint snapshot #{snapshot} · run #{run} · {date}",
      blueprintSnapshotMissing: "No complete personal blueprint snapshot is available.",
      materialEfficiencyApplied: "ME {me} is applied to the assigned goal manufacturing step.",
      timeEfficiencyApplied: "TE {te} reduces the assigned goal manufacturing step's blueprint time.",
      skillStateLabels: { ready: "Skill time available", "snapshot-missing": "Skill snapshot missing" },
      skillEvidence: "Personal skill time basis",
      skillSource: "Skill snapshot #{snapshot} · run #{run} · {date}",
      skillSnapshotMissing: "No complete skill snapshot is available. Personal time remains unknown.",
      skillSummary: "Time after skills {time} · {saved} saved against blueprint time",
      ...
      installationCostTitle: "Complete evidenced installation cost",
      installationCostSummary: "Estimated {total} ISK · EIV {eiv} · system {system} · facility tax {tax} · SCC (4%) {scc}",
      installationCostStateLabels: {
        ready: "Cost basis ready", partial: "Partly costed",
        unconfigured: "Facility tax not configured", unavailable: "Cost basis unavailable",
        "not-applicable": "Not applicable", "not-selected": "No facility selected",
        "facility-snapshot-missing": "Facility snapshot missing", "facility-missing": "Facility missing",
        "facility-unavailable": "Facility unavailable", "cost-index-missing": "System cost index missing",
        "price-snapshot-missing": "Price snapshot missing", "price-missing": "Adjusted price missing",
      },
      installationCostSource: "Price snapshot #{snapshot} · run #{run} · {date}",
      installationCostMissingPrices: "Missing type IDs: {types}",
      materialSaved: "{quantity} saved by ME and facility profile",
      ...
      supplies: "Intermediate supply method",
      supplyHint: "Stock first shortens the manufacturing step; stock/purchase only needs no blueprint.",
      supplyModeLabels: {
        "stock-first": "Stock first", "stock-only": "Stock / purchase only",
        build: "Manufacture",
      },
      supplySummary: "Required {required} · stock {stock} · manufacture {build} · shortage {missing}",
      noBlueprintNeeded: "No blueprint required for this intermediate step",
      ...
      blueprintTime: "Blueprint time {time} · TE {te} saves {saved}",
      gross: "Gross material demand",
      inventory: "Inventory reservation",
      inventoryLabels: {
        covered: "Reservation covered", shortage: "Shortage", "snapshot-missing": "Asset snapshot missing",
      ...
      reservationShortage: "{inventory} physically missing · {conflict} tied up by higher-priority goals",
      priorReservations: "Higher-priority goals · {quantity} reserved across {plans} goals",
      reservationClaim: "Goal #{plan} · {product}",
      reservationClaimDetails: "Priority {priority} · {quantity} reserved",
      reservationsOmitted: "Another {count} prior reservations are included.",
      includedStock: "Inventory snapshot · {quantity} at {locations} locations",
...
function BlueprintProfitabilityPanel({
  ...
  const [runs, setRuns] = useStoredState<number>("blueprint-profitability.runs", 1,
    (v): v is number => Number.isSafeInteger(v) && Number(v) >= 1 && Number(v) <= 10_000);
  const [facilityId, setFacilityId] = useStoredState<number | null>("blueprint-profitability.facility", null, isNullablePositiveInteger);
  const [tax, setTax] = useStoredState<number | null>("blueprint-profitability.tax", null, isNullableBasisPoints);
  const [bonus, setBonus] = useStoredState<number>("blueprint-profitability.bonus", 0,
    (v): v is number => Number.isSafeInteger(v) && Number(v) >= 0 && Number(v) <= 5_000);
  const [offset, setOffset] = useState(0);
  const [previousOffsets, setPreviousOffsets] = useState<number[]>([]);
  const labels = locale === "de" ? {
    runs: "Vergleichsläufe", facility: "Produktionsanlage", tax: "Anlagensteuer (%)", bonus: "Materialbonus der Anlage (%)",
    ...
    capped: "Kopie: Läufe begrenzt", pagePrices: "Preise der angezeigten Blueprints · alle fünf Handelsstationen",
    fees: "Verkaufsgebühren fehlen: Skills und Standings synchronisieren", snapshot: "Blueprint-Stand",
  } : {
    runs: "Comparison runs", facility: "Production facility", tax: "Facility tax (%)", bonus: "Facility material bonus (%)",
    ...
    capped: "Copy: runs capped", pagePrices: "Prices for displayed blueprints · all five trade hubs",
    fees: "Sales fees missing: synchronize skills and standings", snapshot: "Blueprint snapshot",
  };
  useEffect(() => { setOffset(0); setPreviousOffsets([]); }, [ownerCharacterId, search, runs, facilityId, tax, bonus]);
  ...
  useEffect(() => {
    ...
    void loadPlans({
      ...
      inventoryAnalysis: { runs, offset, facilityId, facilityTaxBasisPoints: tax, materialBonusBasisPoints: bonus },
    }).then((result) => {
      if (!active) return;
      setPage(result);
      ...
      .finally(() => { if (active) setLoading(false); });
    return () => { active = false; };
  }, [available, loadPlans, marketRevision, ownerCharacterId, refreshRevision, salesCharacterId, search, runs, offset, facilityId, tax, bonus]);
  ...
  return (
    <section className="asset-browser blueprint-profitability" aria-busy={loading}>
      <header className="asset-deltas__header industry-jobs__header">
        ...
        <div className="asset-hero__metrics"><span><strong>{numberFormat.format(profitability?.inventory?.total ?? 0)}</strong><small>{t.blueprints.positions}</small></span></div>
      </header>
      <div className="asset-toolbar blueprint-profitability__controls">
        ...
        <label><span>{labels.runs}</span><input type="number" min={1} max={10_000} step={1} value={runs} onChange={(event) => { const value = Number(event.target.value); if (Number.isSafeInteger(value) && value >= 1 && value <= 10_000) setRuns(value); }} /></label>
      ...
      {!available ? <div className="asset-empty"><Database size={22} />{t.blueprints.unavailable}</div>
        ...
        : profitability ? <div className="asset-table-wrap"><table className="asset-table blueprint-profitability__table"><thead><tr><th>{t.blueprints.profitability.goal}</th>{marketHubIds.map((hubId) => <th key={hubId}>{hubId === "jita" ? "Jita" : hubId === "amarr" ? "Amarr" : hubId === "dodixie" ? "Dodixie" : hubId === "hek" ? "Hek" : "Rens"}</th>)}<th>{t.blueprints.profitability.best}</th></tr></thead><tbody>{profitability.items.map((item) => <tr key={item.planId}><td><strong>{item.productName}{item.inventory && item.inventory.status !== "ready" ? "" : ` × ${numberFormat.format(item.targetQuantity)}`}</strong><small>{item.blueprintName} · ME {item.appliedMaterialEfficiency} / TE {item.appliedTimeEfficiency}</small><small>{item.ownerName} · {item.inventory?.kind === "copy" ? "BPC" : "BPO"} · #{item.blueprintItemId}</small>
          {item.inventory && <><small>{item.inventory.runs} {labels.runs}{item.inventory.runs < runs ? ` · ${labels.capped}` : ""}</small><small>{labels.snapshot}: {new Date(item.inventory.observedAt).toLocaleString(locale === "de" ? "de-DE" : "en-US")}</small>
          {item.inventory.status !== "ready" && <small>{item.inventory.status === "runs-exhausted" ? labels.exhausted : item.inventory.status === "multiple-products" ? labels.multiple : labels.unknown}</small>}
          {item.inventory.status === "ready" && item.inventory.installationState !== "ready" && <small>{t.productionPlanning.installationCostStateLabels[item.inventory.installationState as keyof typeof t.productionPlanning.installationCostStateLabels]}</small>}</>}</td>{item.comparisons.map((comparison) => <td key={comparison.hubId} className={`blueprint-profitability__${tone(comparison.netProfitCents)}`}><strong>{comparison.netProfitCents === null ? t.blueprints.profitability.noPrice : `${comparison.netProfitCents > 0 ? "+" : ""}${iskFormat.format(comparison.netProfitCents / 100)} ISK`}</strong>{comparison.profitabilityState === "stale" && <small>{t.productionPlanning.marketPricingStateLabels.stale}</small>}{comparison.marketObservedAt && <small>{new Date(comparison.marketObservedAt).toLocaleString(locale === "de" ? "de-DE" : "en-US")}</small>}{comparison.netProfitCents === null && comparison.tradeCostState !== "ready" && <small>{labels.fees}</small>}{comparison.netProfitCents === null && comparison.profitabilityState !== "empty" && <small>{t.productionPlanning.marketPricingStateLabels[comparison.profitabilityState]}</small>}{comparison.netMarginBasisPoints !== null && <small>{t.blueprints.profitability.margin.replace("{margin}", (comparison.netMarginBasisPoints / 100).toLocaleString(locale === "de" ? "de-DE" : "en-US", { minimumFractionDigits: 2, maximumFractionDigits: 2 }))}</small>}{item.bestHubId === comparison.hubId && <span className="status-pill status-pill--info">{t.blueprints.profitability.best}</span>}</td>)}<td><strong>{item.bestHubId === null ? "—" : item.comparisons.find((comparison) => comparison.hubId === item.bestHubId)?.hubName ?? item.bestHubId}</strong></td></tr>)}</tbody></table></div> : null}
...
function ProductionWorkspace({
  ...
  const [newFacilityId, setNewFacilityId] = useStoredState<number | null>("production.facility", null, isNullablePositiveInteger);
  const [newMaterialLocationId, setNewMaterialLocationId] = useStoredState<number | null>("production.material-location", null, isNullablePositiveInteger);
  const [newFacilityMaterialBonus, setNewFacilityMaterialBonus] = useState<number | null>(null);
  const [newFacilityTimeBonus, setNewFacilityTimeBonus] = useState<number | null>(null);
  const [newFacilityTax, setNewFacilityTax] = useState<number | null>(null);
  ...
  const [drafts, setDrafts] = useState<Record<number, {
    owner: number; blueprintItemId: number | null; stepBlueprintItemIds: Record<string, number | null>;
    facilityId: number | null; materialLocationId: number | null;
    facilityMaterialBonus: number | null; facilityTimeBonus: number | null;
  ...
  [newOwner, plans]);
  const newFacility = newFacilityOptions.find((option) => option.facilityId === newFacilityId) ?? null;
  ...
  useEffect(() => {
    if (newFacilityId !== null && !newFacilityOptions.some((option) => option.facilityId === newFacilityId)) {
      ...
      setNewFacilityMaterialBonus(null);
      setNewFacilityTimeBonus(null);
      setNewFacilityTax(null);
    } else if (newMaterialLocationId !== null &&
      !newFacility?.materialLocations.some((option) => option.locationId === newMaterialLocationId)) {
      setNewMaterialLocationId(null);
    }
    ...
    void loadPlans({ search: appliedPlanSearch, ownerCharacterId: planOwner, activity: planActivity,
      ...
      .then((page) => {
        ...
        setDrafts(Object.fromEntries(page.items.map((item) => [item.planId, {
          ...
          facilityId: item.facilityId, materialLocationId: item.materialLocationId,
          facilityMaterialBonus: item.facilityMaterialBonusBasisPoints,
          facilityTimeBonus: item.facilityTimeBonusBasisPoints,
          facilityTax: item.facilityTaxBasisPoints,
          stepBlueprintItemIds: Object.fromEntries(item.steps.slice(0, -1).map((step) => [
            `${step.blueprintTypeId}:${step.activity}:${step.productTypeId}`,
            step.blueprintAssignment.blueprintItemId,
          ])),
          supplyModes: Object.fromEntries(item.supplyDecisions.map((decision) => [
  ...
  const createGoal = async () => {
    ...
    try {
      await savePlan({ planId: null, ownerCharacterId: newOwner,
        blueprintTypeId: selected.blueprintTypeId, blueprintItemId: null, stepBlueprintAssignments: [], activity: selected.activity,
        facilityId: newFacilityId, materialLocationId: newMaterialLocationId,
        facilityMaterialBonusBasisPoints: newFacilityMaterialBonus,
        facilityTimeBonusBasisPoints: newFacilityTimeBonus,
        facilityTaxBasisPoints: newFacilityTax,
        stepSupplyModes: [],
  ...
  const updateGoal = async (item: ProductionPlanPage["items"][number]) => {
    ...
    try {
      await savePlan({ planId: item.planId, ownerCharacterId: draft.owner,
        blueprintTypeId: item.blueprintTypeId, blueprintItemId: draft.blueprintItemId,
        facilityId: draft.facilityId, materialLocationId: draft.materialLocationId,
        facilityMaterialBonusBasisPoints: draft.facilityMaterialBonus,
        facilityTimeBonusBasisPoints: draft.facilityTimeBonus,
        facilityTaxBasisPoints: draft.facilityTax,
        stepBlueprintAssignments: item.steps.slice(0, -1).flatMap((step) => {
          if (step.activity !== "manufacturing") return [];
          const stepKey = `${step.blueprintTypeId}:${step.activity}:${step.productTypeId}`;
          if ((draft.supplyModes[stepKey] ?? step.supplyMode) === "stock-only") return [];
          const blueprintItemId = draft.stepBlueprintItemIds[stepKey];
          return blueprintItemId == null ? [] : [{
        ...
        stepSupplyModes: item.supplyDecisions.map((decision) => ({
          blueprintTypeId: decision.blueprintTypeId,
          activity: decision.activity,
          productTypeId: decision.productTypeId,
          supplyMode: draft.supplyModes[
            `${decision.blueprintTypeId}:${decision.activity}:${decision.productTypeId}`
          ] ?? decision.supplyMode,
      ...
      <section className="production-plans" aria-busy={plansLoading}>
        ...
        {!available ? <div className="asset-empty"><Database size={22} />{t.productionPlanning.queryError}</div>
          ...
          : plans ? <div className="production-plan-list">{plans.items.map((item) => {
              const draft = drafts[item.planId] ?? { owner: item.ownerCharacterId, blueprintItemId: item.blueprintItemId, stepBlueprintItemIds: Object.fromEntries(item.steps.slice(0, -1).map((step) => [`${step.blueprintTypeId}:${step.activity}:${step.productTypeId}`, step.blueprintAssignment.blueprintItemId])), facilityId: item.facilityId, materialLocationId: item.materialLocationId, facilityMaterialBonus: item.facilityMaterialBonusBasisPoints, facilityTimeBonus: item.facilityTimeBonusBasisPoints, facilityTax: item.facilityTaxBasisPoints, supplyModes: Object.fromEntries(item.supplyDecisions.map((decision) => [`${decision.blueprintTypeId}:${decision.activity}:${decision.productTypeId}`, decision.supplyMode])), quantity: item.targetQuantity, priority: item.priority, note: item.note ?? "" };
              const blueprintCandidates = draft.owner === item.ownerCharacterId ? item.blueprintCandidates : [];
              const draftFacilityOptions = plans.locationOptions.filter((option) => option.ownerCharacterId === draft.owner);
              const draftFacility = draftFacilityOptions.find((option) => option.facilityId === draft.facilityId) ?? null;
              return <article className="production-plan-card" key={item.planId}>
                ...
                <div className="production-blueprint-evidence"><strong>{item.blueprintItemId === null ? t.productionPlanning.noBlueprint : t.productionPlanning.blueprintEvidence.replace("{kind}", item.blueprintKind === "original" ? "BPO" : "BPC").replace("{item}", String(item.blueprintItemId)).replace("{me}", String(item.blueprintMaterialEfficiency ?? 0)).replace("{te}", String(item.blueprintTimeEfficiency ?? 0)).replace("{runs}", item.blueprintRuns === -1 ? "∞" : numberFormat.format(item.blueprintRuns ?? 0))}</strong><span>{item.blueprintSnapshotId === null ? t.productionPlanning.blueprintSnapshotMissing : t.productionPlanning.blueprintSource.replace("{snapshot}", String(item.blueprintSnapshotId)).replace("{run}", String(item.blueprintSyncRunId)).replace("{date}", String(item.blueprintObservedAt))}</span>{item.appliedMaterialEfficiency > 0 && <span>{t.productionPlanning.materialEfficiencyApplied.replace("{me}", String(item.appliedMaterialEfficiency))}</span>}{item.appliedTimeEfficiency > 0 && <span>{t.productionPlanning.timeEfficiencyApplied.replace("{te}", String(item.appliedTimeEfficiency))}</span>}</div>
                <div className="production-blueprint-evidence production-skill-evidence"><strong>{t.productionPlanning.skillEvidence}</strong><span>{item.skillSnapshotId === null ? t.productionPlanning.skillSnapshotMissing : t.productionPlanning.skillSource.replace("{snapshot}", String(item.skillSnapshotId)).replace("{run}", String(item.skillSyncRunId)).replace("{date}", String(item.skillObservedAt))}</span>{item.totalCharacterTimeSeconds !== null && item.characterSkillTimeSavingsSeconds !== null && <span>{t.productionPlanning.skillSummary.replace("{time}", formatDuration(item.totalCharacterTimeSeconds)).replace("{saved}", formatDuration(item.characterSkillTimeSavingsSeconds))}</span>}</div>
                <div className="production-blueprint-evidence production-skill-evidence"><strong>{t.productionPlanning.facilityProfile}</strong><span>{item.facilityModifierState === "ready" ? t.productionPlanning.facilityProfileSummary.replace("{material}", (Number(item.facilityMaterialBonusBasisPoints) / 100).toLocaleString(locale === "de" ? "de-DE" : "en-US", { maximumFractionDigits: 2 })).replace("{time}", (Number(item.facilityTimeBonusBasisPoints) / 100).toLocaleString(locale === "de" ? "de-DE" : "en-US", { maximumFractionDigits: 2 })) : t.productionPlanning.facilityModifierStateLabels[item.facilityModifierState]}</span>{item.totalFacilityTimeSeconds !== null && item.facilityTimeSavingsSeconds !== null && <span>{t.productionPlanning.facilityTimeSummary.replace("{time}", formatDuration(item.totalFacilityTimeSeconds)).replace("{saved}", formatDuration(item.facilityTimeSavingsSeconds))}</span>}</div>
                <div className="production-blueprint-evidence production-skill-evidence"><strong>{t.productionPlanning.installationCostTitle}</strong><span className={`status-pill status-pill--${item.installationCostState === "ready" ? "good" : item.installationCostState === "partial" ? "info" : "warn"}`}>{t.productionPlanning.installationCostStateLabels[item.installationCostState]}</span>{item.estimatedInstallationCost !== null && item.estimatedItemValue !== null && item.systemCost !== null && item.facilityTax !== null && item.sccSurcharge !== null && <span>{t.productionPlanning.installationCostSummary.replace("{total}", numberFormat.format(item.estimatedInstallationCost)).replace("{eiv}", numberFormat.format(item.estimatedItemValue)).replace("{system}", numberFormat.format(item.systemCost)).replace("{tax}", numberFormat.format(item.facilityTax)).replace("{scc}", numberFormat.format(item.sccSurcharge))}</span>}</div>
                ...
                {item.state === "ready" && <div className="production-resolution">
                  {item.supplyDecisions.length > 0 && <details className="production-supply" open><summary>{t.productionPlanning.supplies} · {item.supplyDecisions.length}</summary><p className="production-sequence-hint">{t.productionPlanning.supplyHint}</p><ul className="production-supply-list">{item.supplyDecisions.map((decision) => {
                    const key = `${decision.blueprintTypeId}:${decision.activity}:${decision.productTypeId}`;
                    const mode = draft.supplyModes[key] ?? decision.supplyMode;
                    return <li key={key}><span><strong>{decision.productName}</strong><small>{t.productionPlanning.supplySummary.replace("{required}", numberFormat.format(decision.requiredQuantity)).replace("{stock}", numberFormat.format(decision.stockUsedQuantity)).replace("{build}", numberFormat.format(decision.buildQuantity)).replace("{missing}", numberFormat.format(decision.shortageQuantity))}</small>{(mode === "stock-only" || !decision.blueprintRequired) && <small>{t.productionPlanning.noBlueprintNeeded}</small>}</span><label><span>{t.productionPlanning.materialSource}</span><select value={mode} onChange={(event) => setDrafts((current) => ({ ...current, [item.planId]: { ...draft, supplyModes: { ...draft.supplyModes, [key]: event.target.value as ProductionSupplyMode } } }))}>{(["stock-first", "stock-only", "build"] as const).map((value) => <option key={value} value={value}>{t.productionPlanning.supplyModeLabels[value]}</option>)}</select></label></li>;
                  })}</ul></details>}
                  <details open><summary>{t.productionPlanning.steps} · {item.steps.length}</summary><p className="production-sequence-hint">{t.productionPlanning.sequenceHint}</p><ol>{item.steps.map((step, index) => {
                    const isGoal = index === item.steps.length - 1;
                    const skillLevels = step.timeSkills.map((skill) => `${skill.skillName} ${skill.activeLevel ?? "—"}`).join(" · ");
                    const skillTime = step.totalCharacterTimeSeconds === null || step.characterSkillTimeSavingsSeconds === null
                      ? t.productionPlanning.characterTimeUnknown
                      : step.characterSkillTimeSavingsSeconds > 0
                        ? t.productionPlanning.characterTime.replace("{time}", formatDuration(step.totalCharacterTimeSeconds)).replace("{skills}", skillLevels).replace("{saved}", formatDuration(step.characterSkillTimeSavingsSeconds))
                        : t.productionPlanning.characterTimeUnchanged.replace("{time}", formatDuration(step.totalCharacterTimeSeconds)).replace("{skills}", skillLevels);
                    const stepKey = `${step.blueprintTypeId}:${step.activity}:${step.productTypeId}`;
                    const stepAssignment = step.blueprintAssignment;
                    const stepCandidates = draft.owner === item.ownerCharacterId
                      ? stepAssignment.blueprintCandidates : [];
                    const stepBlueprintItemId = isGoal
                      ? draft.blueprintItemId
                      : draft.stepBlueprintItemIds[stepKey] ?? null;
                    const stepSupplyMode = draft.supplyModes[stepKey] ?? step.supplyMode;
                    const facility = step.facilityEvidence;
                    const installationCost = step.installationCost;
                  ...
                  <details open><summary>{t.productionPlanning.inventory} · {item.grossMaterials.length}</summary>{item.grossMaterials.length === 0 ? <p>{t.productionPlanning.noGross}</p> : <ul className="production-material-list">{item.grossMaterials.map((material) => <li key={material.typeId}>
                    ...
                    <div className="production-material-metrics"><span><small>{t.productionPlanning.required}</small><strong>{numberFormat.format(material.quantity)}</strong>{material.materialEfficiencySavings > 0 && <small>{t.productionPlanning.materialSaved.replace("{quantity}", numberFormat.format(material.materialEfficiencySavings))}</small>}</span><span><small>{t.productionPlanning.available}</small><strong>{material.availableQuantity === null ? "—" : numberFormat.format(material.availableQuantity)}</strong></span><span><small>{t.productionPlanning.reserved}</small><strong>{material.reservedQuantity === null ? "—" : numberFormat.format(material.reservedQuantity)}</strong></span><span><small>{t.productionPlanning.remaining}</small><strong>{material.remainingQuantity === null ? "—" : numberFormat.format(material.remainingQuantity)}</strong></span><span className={material.missingQuantity !== null && material.missingQuantity > 0 ? "is-shortage" : ""}><small>{t.productionPlanning.missing}</small><strong>{material.missingQuantity === null ? "—" : numberFormat.format(material.missingQuantity)}</strong></span></div>
                    {material.availabilityState === "snapshot-missing" ? <p className="production-material-note"><AlertTriangle size={14} />{t.productionPlanning.snapshotMissing}</p> : <>
                      {material.missingQuantity !== null && material.missingQuantity > 0 && <p className="production-reservation-shortage"><AlertTriangle size={14} />{t.productionPlanning.reservationShortage.replace("{inventory}", numberFormat.format(material.inventoryShortageQuantity ?? 0)).replace("{conflict}", numberFormat.format(material.reservationConflictQuantity ?? 0))}</p>}
                      {(material.reservedByPriorPlansQuantity ?? 0) > 0 && <div className="production-stock-evidence production-stock-evidence--reservations"><details><summary>{t.productionPlanning.priorReservations.replace("{quantity}", numberFormat.format(material.reservedByPriorPlansQuantity ?? 0)).replace("{plans}", numberFormat.format(material.priorReservationCount))}</summary><ul>{material.priorReservations.map((claim) => <li key={claim.planId}><span><strong>{t.productionPlanning.reservationClaim.replace("{plan}", String(claim.planId)).replace("{product}", claim.productName)}</strong><small>Type #{claim.productTypeId}</small></span><span><strong>{t.productionPlanning.reservationClaimDetails.replace("{priority}", numberFormat.format(claim.priority)).replace("{quantity}", numberFormat.format(claim.quantity))}</strong><small>{claim.createdAt}</small></span></li>)}</ul>{material.priorReservationCount > material.priorReservations.length && <p>{t.productionPlanning.reservationsOmitted.replace("{count}", numberFormat.format(material.priorReservationCount - material.priorReservations.length))}</p>}</details></div>}
                      <div className="production-stock-evidence"><details><summary>{t.productionPlanning.includedStock.replace("{quantity}", numberFormat.format(material.availableQuantity ?? 0)).replace("{locations}", numberFormat.format(material.availableLocationCount))}</summary><ul>{material.availableLocations.map((location) => <li key={`${location.ownerCharacterId}:${location.locationId}:${location.locationFlag}`}><span><strong>{location.locationPath || `Location #${location.locationId}`}</strong><small>{location.ownerName} · {location.locationFlag}</small></span><span><strong>{t.productionPlanning.stockPosition.replace("{quantity}", numberFormat.format(location.quantity)).replace("{positions}", numberFormat.format(location.positionCount))}</strong><small>{t.productionPlanning.stockSource.replace("{snapshot}", String(location.assetSnapshotId)).replace("{run}", String(location.assetSyncRunId)).replace("{date}", location.assetObservedAt)}</small></span></li>)}</ul>{material.availableLocationCount > material.availableLocations.length && <p>{t.productionPlanning.locationsOmitted.replace("{count}", numberFormat.format(material.availableLocationCount - material.availableLocations.length))}</p>}</details></div>
                    </>}
