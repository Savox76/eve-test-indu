...
Paket 28 ergänzt die streng begrenzte Route `/industry-slots/query`. Sie stellt für jeden Charakter Fertigungs-, Reaktions- und Wissenschaftskapazität aus den aktuell wirksamen Slot-Skills der realen Belegung durch aktive, pausierte und abholbereite Jobs gegenüber. Die Forschungspläne aus Schema 8 liefern den belegbaren Wissenschafts-Arbeitsvorrat. Fehlende Skill- oder Job-Snapshots bleiben unabhängig voneinander `null`; Fertigungs- und Reaktionspläne werden bis zur Produktionsplanung nicht erfunden. Jede Antwort führt die verwendeten Snapshot-, Sync-Run- und Zeitbelege mit.
