...
**Fassung:** 3.4 (lebendes Repository-Dokument)

**Stand:** 11. September 2026

**Status:** Paket 28 – Industrie-Slotübersicht technisch abgeschlossen; Windows-A0 für Paket 22 bleibt offen
...
- **In Arbeit:** 22 – Der Gerätetest bestätigte Einzelinstanz, zweiten Start und updatefesten Speicher. `v0.0.5-preview.11` ist der aktuelle technische Kandidat. Das vollständige A0-Protokoll bleibt vor der ersten `0.2.0`-Alpha erforderlich.
...
- **Als Nächstes:** Paket 29 erweitert den atomaren SDE-Import um die für Fertigung und Reaktionen benötigten Blueprintaktivitäten, Produkte, Materialien und Basiszeiten. Das noch offene Paket 22 wird unabhängig davon mit dem vollständigen Windows-A0-Protokoll für den aktuellen Kandidaten abgeschlossen. Die bereits technisch vorgezogenen Fachpakete 23–28 bleiben Previews; eine erste `0.2.0`-Alpha wird erst nach bestandenem A0 freigegeben.
