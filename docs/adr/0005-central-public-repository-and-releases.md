...
- Jedes Windows-Release enthält einen Installer und eine portable ZIP mit jeweils eigener SHA-256-Prüfsumme.
- Installationsdateien, portable Pakete, Prüfsummen, Signaturen und Update-Manifeste werden nur für eine freigegebene Version direkt an das zugehörige GitHub Release angehängt.
...
Releases und ihre selbst hochgeladenen Installations- und Portable-Dateien sind öffentlich erreichbar. GitHub stellt zusätzlich bei jedem Release automatisch ZIP- und Tarball-Archive des Quellcodes am Tag bereit. Diese Quellcodearchive unterscheiden sich von der eigens gebauten portablen Windows-ZIP, sind keine Actions-Artefakte und gehören zum öffentlichen Repository-Modell.
